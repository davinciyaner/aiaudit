...
const PERSONAS = [
    ...
    {
        icon: Users2,
        title: 'Agenturen mit mehreren Kunden',
        pain: 'Ein Tool pro Kunde einzeln abrechnen und verwalten ist ein Alptraum.',
        solves: 'Modulare Abrechnung pro Kunde statt Pauschal-Lizenz.',
    },
]
            ...
            <div className="relative max-w-6xl mx-auto px-5 sm:px-8">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                    ...
                    <h2 className="text-3xl sm:text-5xl font-bold tracking-tight mb-4 leading-tight text-balance">
                        Gebaut für alle, die KI-Sichtbarkeit und SEO nicht getrennt tracken wollen
                    </h2>
                </motion.div>
