            ...
            {visible && (
                ...
                >
                    ...
                    <div className="flex items-center justify-between px-4 sm:px-5 pt-4 pb-3 border-b border-[var(--border-subtle)]">
                        <span className="text-[11px] font-semibold uppercase tracking-wider text-[var(--text-faint)]">Schnelles Feedback</span>
                        {step !== 'done' && (
                            <button
                                onClick={dismiss}
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            {step === 'done' && (
                                <motion.div key="done"
                                    ...
                                    <div>
                                        <p className="text-sm font-semibold text-[var(--text-white)]">Danke für dein Feedback!</p>
                                        <p className="text-xs text-[var(--text-faint)] mt-1">Das hilft uns sehr, die Seite zu verbessern.</p>
                                    </div>
                                </motion.div>
                            )}
