        ...
        <section id="pricing" className="relative py-16 md:py-28 bg-[var(--bg-base)] overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8">
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
                    ...
                    <p className="text-lg text-[var(--text-muted)] max-w-xl mx-auto">No hidden fees. Monthly subscription. Cancel anytime.</p>
                </motion.div>
                        ...
                        <motion.div key={plan.id}
                            ...
                            {plan.id === 'free' ? (
                                <button onClick={handleFreeCta}
                                    className="block w-full py-4 text-center text-sm font-semibold rounded-xl transition-all duration-200 border border-[var(--border-strong)] text-[var(--text-body)] hover:text-[var(--text-white)] hover:bg-[var(--surface-06)]">
                                    {plan.cta}
                                </button>
                            ) : (
