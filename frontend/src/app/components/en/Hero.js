...
const STATS = [
    { value: 'max. 60s', label: 'until your report' },
                            ...
                            <AnimatePresence mode="wait">
                                {showError ? (
                                    <motion.p key="err"
                                        ...
                                        Please enter your website address first
                                    </motion.p>
                                ) : (
                                    <motion.p key="lbl"
                        ...
                        <div className="max-w-2xl mx-auto">
                            {showError && (
                                <p className="text-xs text-red-400 mb-1.5 flex items-center gap-1">
                                    Enter your website address first, e.g. yourcompany.com
                                </p>
                            )}
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div className="flex items-center gap-1.5 text-xs text-slate-400">
                                    ...
                                    <span>websites already analyzed</span>
                                </div>
                            </div>
                            ...
                            <p className="text-sm sm:text-base text-slate-400 mb-5 sm:mb-6 max-w-3xl mx-auto">
                                Your website&apos;s SEO and AI visibility, analyzed in 60 seconds.
                            </p>
                            ...
                            <div className="mb-5 sm:mb-8 w-full max-w-2xl mx-auto">
                                ...
                                <form ref={formRef} onSubmit={e => submitWithRef(e, inputRef)}
                                    ...
                                    <button type="submit"
                                        ...
                                        <Search className="w-4 h-4" />
                                        <span className="hidden sm:inline">Check website</span>
                                ...
                                <AnimatePresence mode="wait" initial={false}>
                                    {showError ? (
                                        ...
                                        <motion.p key="info"
                                            ...
                                            Free · No sign-up required · 60 seconds
                                        </motion.p>
                                    )}
                                </AnimatePresence>

                                <div className="flex flex-wrap items-center justify-center gap-2">
                                    <span className="text-md text-slate-300">More than a one-time check:</span>
                                    <Link href="/seo/dashboard"
                                        ...
                                        <span className="text-xs font-semibold text-emerald-300">SEO Automation</span>
                                    ...
                                    <Link href="/geo/dashboard"
                                        ...
                                        <span className="text-xs font-semibold text-violet-300">GEO Automation</span>
