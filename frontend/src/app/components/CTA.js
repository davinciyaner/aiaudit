...
export default function CTA() {
    return (
        <>
            ...
            <section id="security" className="relative py-20 md:py-32 bg-[#05080f]">
            ...
            {/* Final CTA */}
            <section className="relative py-20 md:py-32 overflow-hidden bg-[#05080f]">
