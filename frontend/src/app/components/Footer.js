    ...
    return (
        <>
            <footer className="border-t border-white/5 bg-[#05080f]">
                <div className="max-w-7xl mx-auto px-5 sm:px-8 py-10 flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-3 text-xs text-slate-600">
                        ...
                        <button onClick={() => setSupportOpen(true)} className="hover:text-slate-400 transition-colors">
                            Support
                        </button>
