                ...
                {ticket && currentStatus && (
                    ...
                    >
                        ...
                        <div className="bg-[var(--text-white)]/[0.02] border border-[var(--text-white)]/[0.06] rounded-2xl p-6 space-y-3">
                            <p className="text-xs text-[var(--text-faint)] uppercase tracking-wider font-semibold mb-2">Nachrichten</p>

                            <div className="bg-[var(--text-white)]/[0.03] rounded-xl p-4">
                                <p className="text-xs text-[var(--text-faint)] mb-1">Deine Nachricht</p>
                            ...
                            {ticket.status === 'closed' && (
                                <p className="text-xs text-amber-400/80">Dieses Ticket ist geschlossen — eine Antwort öffnet es wieder.</p>
                            )}
