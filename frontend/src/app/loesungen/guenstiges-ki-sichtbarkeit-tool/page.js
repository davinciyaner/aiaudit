...
const faqLd = {
    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'Die GEO-Automatisierung startet bei 4,99 €/Monat (Claude, 1 Website, 10 Keywords, wöchentlicher Auto-Check). Der Pro-Plan für 9,99 €/Monat deckt alle vier KI-Plattformen ab. SEO-Automatisierung startet separat bei 19 €/Monat. Alle Automatisierungs-Pläne haben 14 Tage kostenlose Testphase.',
            },
        },
        {
            '@type': 'Question',
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'Claude, ChatGPT, Perplexity und Google AI Overview. Im Einsteiger-Plan ist Claude enthalten, ab dem Pro-Plan (9,99 €/Monat) sind alle vier Plattformen inklusive – ohne separate Add-on-Kosten pro Plattform.',
            },
        },
    ],
}
...
const PRICING_ROWS = [
    ...
    ['GEO Pro', 'ChatGPT + Claude + Perplexity + Google AI Overview · 3 Websites · 30 Keywords', '9,99 €/Monat'],
