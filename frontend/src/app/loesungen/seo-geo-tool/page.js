...
export default function SeoGeoToolPage() {
    return (
        <main className="bg-[var(--bg-base)] min-h-screen">
            ...
            <div className="max-w-4xl mx-auto px-5 sm:px-8 pt-28 flex items-center gap-2 text-xs text-[var(--text-faint)]">
            ...
            <section className="max-w-4xl mx-auto px-5 sm:px-8 pt-8 sm:pt-10 pb-16 text-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-3 mb-3">
                    ...
                    <Link href="/blog/seo-geo-automatisierung"
                        className="inline-flex items-center gap-2 px-6 py-3 bg-[var(--surface-08)] hover:bg-[var(--surface-10)] border border-[var(--border-subtle)] text-[var(--text-body)] hover:text-[var(--text-white)] text-sm font-semibold rounded-xl transition-all">
                        So funktioniert's im Detail
                    </Link>
                </div>
                <p className="text-xs text-[var(--text-faint)]">Keine Kreditkarte nötig · Ergebnis in 60 Sekunden</p>
            ...
            <section className="max-w-4xl mx-auto px-5 sm:px-8 py-16 border-t border-[var(--border-subtle)]">
                <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text-white)] text-center mb-4">Warum SEO allein nicht mehr reicht</h2>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-4">
                    <div className="bg-[var(--bg-surface)] border border-red-500/20 rounded-2xl p-6">
                        <h3 className="font-bold text-[var(--text-white)] mb-2">Nur SEO-Tools</h3>
                        <p className="text-sm text-[var(--text-muted)] leading-relaxed">Zeigen Google-Rankings - aber nichts darüber, ob dich KI-Modelle überhaupt kennen oder empfehlen. Der wachsende Teil der Suche bleibt unsichtbar.</p>
                    </div>
                    <div className="bg-[var(--bg-surface)] border border-red-500/20 rounded-2xl p-6">
                        <h3 className="font-bold text-[var(--text-white)] mb-2">Nur GEO-Tools</h3>
                        <p className="text-sm text-[var(--text-muted)] leading-relaxed">Zeigen KI-Zitierungen - aber ignorieren, dass klassisches Google-Ranking weiterhin die Mehrheit des Traffics bringt. Ein blinder Fleck in die andere Richtung.</p>
                    </div>
                </div>
                <div className="bg-[var(--accent-soft)] border border-[var(--accent-border)] rounded-2xl p-6">
                    <h3 className="font-bold text-[var(--text-white)] mb-2">Scanora: beides zusammen</h3>
                    <p className="text-sm text-[var(--text-body)] leading-relaxed">SEO-Rankings und KI-Sichtbarkeit für dieselben Keywords, im selben Dashboard - inklusive der Überschneidung: rankst du bei Google, aber die KI kennt dich nicht? Oder umgekehrt? Genau das siehst du hier zuerst.</p>
                </div>
            </section>

            {/* WAS IST GEO */}
            <section className="max-w-4xl mx-auto px-5 sm:px-8 py-16 border-t border-[var(--border-subtle)]">
                <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text-white)] text-center mb-4">Was ist Generative Engine Optimization (GEO)?</h2>
                <div className="bg-[var(--bg-surface)] border border-[var(--accent-border)] border-l-4 border-l-[var(--accent)] rounded-2xl p-6 sm:p-7 mb-5">
                    <p className="text-[var(--text-body)] leading-relaxed">
                        <strong className="text-[var(--text-white)]">Generative Engine Optimization (GEO)</strong> ist die Praxis, eine Website so zu gestalten, dass KI-Modelle wie ChatGPT, Claude, Gemini und Perplexity sie in ihren Antworten zitieren und empfehlen - genauso wie SEO eine Website für klassische Google-Rankings optimiert.
                    </p>
                </div>
            ...
            {/* DASHBOARDS */}
            <section className="max-w-4xl mx-auto px-5 sm:px-8 py-16 border-t border-[var(--border-subtle)]">
                <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text-white)] text-center mb-4">Zwei Dashboards, ein durchgehendes Bild</h2>
                <p className="text-[var(--text-muted)] text-center max-w-xl mx-auto mb-10 leading-relaxed">
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-4">
                    <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-2xl overflow-hidden">
                        <div className="px-5 py-4 border-b border-[var(--border-subtle)] flex items-center justify-between">
                            <span className="text-sm font-bold text-[var(--text-white)]">📈 SEO-Dashboard</span>
                            ...
                            {DASHBOARD_SEO.map(row => (
                                <div key={row.label} className="flex items-center justify-between py-1.5 border-b border-[var(--border-subtle)] last:border-0 text-sm">
                                    <span className="flex items-center gap-2 text-[var(--text-body)]">
                                        <span className={`w-1.5 h-1.5 rounded-full ${row.up ? 'bg-[var(--accent)]' : 'bg-[var(--text-faint)]'}`} />
                                        {row.label}
                                    </span>
                                    <span className="text-xs text-[var(--text-faint)]">{row.value}{row.up ? ' ↑' : ''}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-2xl overflow-hidden">
                        <div className="px-5 py-4 border-b border-[var(--border-subtle)] flex items-center justify-between">
                            <span className="text-sm font-bold text-[var(--text-white)]">🤖 GEO-Dashboard</span>
                        ...
                        <div className="p-5 space-y-2">
                            {DASHBOARD_GEO.map(row => (
                                <div key={row.label} className="flex items-center justify-between py-1.5 border-b border-[var(--border-subtle)] last:border-0 text-sm">
                                    <span className="flex items-center gap-2 text-[var(--text-body)]">
                                        <span className={`w-1.5 h-1.5 rounded-full ${row.ok ? 'bg-[var(--accent)]' : 'bg-[var(--text-faint)]'}`} />
                                        {row.label}
                                    </span>
                                    <span className="text-xs text-[var(--text-faint)]">{row.ok ? 'Erwähnt' : 'Nicht erwähnt'}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-2xl overflow-hidden">
                    <div className="px-5 py-4 border-b border-[var(--border-subtle)]">
                        <span className="text-sm font-bold text-[var(--text-white)]">🔗 SEO ↔ GEO Überschneidung - der eigentliche Unterschied zu zwei separaten Tools</span>
                    </div>
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm min-w-[520px]">
                            <thead>
                                <tr className="border-b border-[var(--border-subtle)]">
                                    <th className="text-left px-5 py-3 text-[10px] uppercase tracking-wider text-[var(--text-faint)] font-semibold">Keyword</th>
                                    <th className="text-left px-5 py-3 text-[10px] uppercase tracking-wider text-[var(--text-faint)] font-semibold">Google-Position</th>
                                    <th className="text-left px-5 py-3 text-[10px] uppercase tracking-wider text-[var(--text-faint)] font-semibold">Von KI erwähnt?</th>
                                    <th className="text-left px-5 py-3 text-[10px] uppercase tracking-wider text-[var(--text-faint)] font-semibold">Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                {CORRELATION_ROWS.map(row => (
                                    <tr key={row.keyword} className="border-b border-[var(--border-subtle)] last:border-0">
                                        <td className="px-5 py-3 text-[var(--text-body)]">{row.keyword}</td>
                                        <td className="px-5 py-3 text-[var(--text-body)]">{row.position}</td>
                                        <td className="px-5 py-3 text-[var(--text-body)]">{row.mentioned ? 'Ja' : 'Nein'}</td>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {FEATURES.map(f => (
                        <div key={f.title} className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-2xl p-5">
                            ...
                            <h3 className="font-bold text-[var(--text-white)] text-sm mb-1.5">{f.title}</h3>
                            <p className="text-xs text-[var(--text-faint)] leading-relaxed">{f.desc}</p>
                        </div>
                    ))}
                </div>
                <p className="text-sm text-[var(--text-muted)] leading-relaxed mt-8 max-w-2xl mx-auto text-center">
            ...
            <section className="max-w-4xl mx-auto px-5 sm:px-8 py-16 border-t border-[var(--border-subtle)]">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-2xl p-6">
                        <h3 className="font-bold text-[var(--text-white)] text-sm mb-3">Inhouse-Marketing-Teams</h3>
                        <p className="text-sm text-[var(--text-muted)] leading-relaxed">
                    ...
                    <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-2xl p-6">
                        <h3 className="font-bold text-[var(--text-white)] text-sm mb-3">SaaS- &amp; Produkt-Teams</h3>
                        <p className="text-sm text-[var(--text-muted)] leading-relaxed">
                    ...
                    <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-2xl p-6">
                        <h3 className="font-bold text-[var(--text-white)] text-sm mb-3">Einzelunternehmer &amp; kleine Websites</h3>
                        <p className="text-sm text-[var(--text-muted)] leading-relaxed">
            ...
            {/* FAQ */}
            <section className="max-w-4xl mx-auto px-5 sm:px-8 py-16 border-t border-[var(--border-subtle)]">
                <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text-white)] text-center mb-10">Häufige Fragen</h2>
            ...
            <section className="max-w-4xl mx-auto px-5 sm:px-8 pb-24">
                <div className="text-center rounded-3xl p-10 sm:p-14"
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text-white)] mb-3">Finde in 60 Sekunden heraus, wo du stehst</h2>
                    <p className="text-[var(--text-muted)] mb-7">SEO-Rankings und KI-Sichtbarkeit - ein Audit, ein Dashboard.</p>
                    <Link href="/dashboard"
                        className="inline-flex items-center gap-2 px-7 py-3.5 bg-[var(--accent)] hover:opacity-90 text-[var(--bg-base)] text-sm font-semibold rounded-xl transition-all shadow-lg shadow-[var(--accent-border)] active:scale-[0.97] active:duration-75">
