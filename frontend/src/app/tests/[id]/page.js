            ...
            <div className="max-w-4xl mx-auto px-5 sm:px-8 py-12">
                ...
                {!data && !error && (
                    <div className="flex flex-col items-center justify-center py-32 gap-4">
                        ...
                        <p className="text-[var(--text-faint)] text-sm">Test wird geladen…</p>
                    </div>
                )}
                ...
                {error && (
                    <div className="bg-red-500/8 border border-red-500/20 rounded-2xl p-8 text-center">
                        ...
                        <p className="text-[var(--text-white)] font-semibold mb-1">Test nicht gefunden</p>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                        ...
                        {data.summary && (
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                <StatCard icon={BarChart2}      label="Gesamt"    value={data.summary.total}            color="bg-[var(--text-faint)]/15 text-[var(--text-muted)]" />
                        ...
                        {data.steps?.length > 0 && (
                            <div className="bg-[var(--text-white)]/[0.02] border border-[var(--text-white)]/[0.06] rounded-2xl p-4 space-y-2">
                                <h2 className="text-sm font-semibold text-[var(--text-muted)] mb-3">Schritte</h2>
