export const metadata = {
    ...
    description: 'GEO Check kostenlos: Prüfe einmalig, ob deine Website von ChatGPT, Claude, Perplexity oder Google AI Overview zitiert wird. Keine Registrierung nötig.',
