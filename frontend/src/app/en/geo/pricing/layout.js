export const metadata = {
    ...
    alternates: {
        canonical: 'https://www.scanora.ai/en/geo/pricing',
        languages: {
    ...
    openGraph: {
        title: 'GEO Automation Pricing | Scanora',
...
const faqJsonLd = {
    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: "A one-time GEO audit (included in Scanora's free website audit) shows your GEO score at a single point in time. GEO automation runs an automatic weekly check across ChatGPT, Claude, Perplexity, and Google AI Overview, giving you a trend over time instead of just a snapshot.",
            },
        },
        {
            '@type': 'Question',
...
const geoJsonLd = {
    ...
    '@id': 'https://www.scanora.ai/en/geo/pricing#software',
    name: 'Scanora GEO Automation',
    url: 'https://www.scanora.ai/en/geo/pricing',
