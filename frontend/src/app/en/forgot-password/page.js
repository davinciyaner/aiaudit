            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
                ...
                {sent ? (
                    <div className="bg-[var(--surface-06)] border border-[var(--border-subtle)] rounded-2xl p-8 text-center">
                        ...
                        <h1 className="text-2xl font-bold text-[var(--text-white)] mb-3">Email sent</h1>
                        <p className="text-[var(--text-muted)] text-sm leading-relaxed mb-6">
                            If an account with <strong className="text-[var(--text-body)]">{email}</strong> exists, we've sent a reset link. Please also check your spam folder.
                        </p>
                        <p className="text-xs text-[var(--text-faint)] mb-6">The link is valid for 1 hour.</p>
                        <Link href="/en/login" className="inline-flex items-center gap-2 text-sm text-[var(--text-white)] hover:text-[var(--accent)] transition-colors font-medium">
                    ...
                    <>
                        <div className="mb-8">
                            <h1 className="text-3xl font-bold text-[var(--text-white)] mb-2">Forgot your password?</h1>
                            <p className="text-[var(--text-muted)] text-sm">Enter your email – we'll send you a reset link.</p>
                        </div>
                        ...
                        <div className="mt-6 text-center">
                            <Link href="/en/login" className="inline-flex items-center gap-1.5 text-sm text-[var(--text-faint)] hover:text-[var(--text-muted)] transition-colors">
