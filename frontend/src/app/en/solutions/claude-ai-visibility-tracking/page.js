...
const faqLd = {
    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'Yes. The Starter plan (€4.99/month) covers Claude alone, and the Pro plan (€9.99/month) adds ChatGPT, Perplexity, and Google AI Overview in the same dashboard - no separate booking per platform.',
            },
        },
        {
            '@type': 'Question',
            ...
            <article className="max-w-3xl mx-auto px-5 sm:px-8 pt-32 pb-24">
                ...
                <div className="space-y-10 text-slate-300 leading-relaxed">
                    ...
                    <section>
                        ...
                        <p>
                            From the Starter plan (€4.99/month, 1 website, 10 keywords), AuditAI automatically checks every week whether Claude mentions your website - including a mention history over time. The Pro plan (€9.99/month) adds ChatGPT, Perplexity, and Google AI Overview in the same dashboard, plus two prompt variants per keyword instead of one.
                        </p>
                        <p className="mt-4">
