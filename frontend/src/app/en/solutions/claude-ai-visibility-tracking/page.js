...
const faqLd = {
    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'Yes. The Starter plan (€4.99/month) covers Claude and Gemini, and the Pro plan (€19.99/month) adds ChatGPT, Perplexity, and Google AI Overview in the same dashboard - no separate booking per platform.',
            },
        },
        {
            '@type': 'Question',
