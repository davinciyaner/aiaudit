            ...
            <div className="flex-1 flex items-center justify-center px-5 py-12 order-2 lg:order-1">
                ...
                <motion.div initial={{opacity: 0, y: 30}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}
                    ...
                    <div className="mb-8">
                        ...
                        {hasPendingAudit && (
                            <div className="flex items-center gap-2 mt-3 px-3 py-2 bg-violet-500/10 border border-violet-500/20 rounded-xl">
                                <p className="text-xs text-violet-300">Your audit is waiting — you'll see the results right after signing up.</p>
                            </div>
                        )}
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-xs text-slate-400 leading-relaxed">
                                I have read the{' '}
                                <Link href="/nutzungsbedingungen" target="_blank" className="text-violet-400 hover:text-violet-300 underline underline-offset-2">Terms of Service</Link>{' '}
                                and the{' '}
                                <Link href="/datenschutz" target="_blank" className="text-violet-400 hover:text-violet-300 underline underline-offset-2">Privacy Policy</Link>{' '}
                                and agree to them.
                            </span>
                        </label>
                    ...
                    <div className="text-center text-sm text-slate-500">
                        ...
                        <Link href="/en/login" className="text-cyan-400 hover:text-cyan-300 font-medium transition-colors">
                            Log in
                        </Link>
                    </div>
              ...
              Audit<span className="text-transparent bg-clip-text bg-linear-to-r from-violet-400 to-cyan-400">AI</span>
                ...
                <div className="relative z-10">
                    <h2 className="text-4xl font-bold text-white leading-tight mb-4">
                        Sign up once.<br/>
                        <span className="text-transparent bg-clip-text bg-linear-to-r from-violet-400 to-cyan-400">Stay on top of it always.</span>
                    </h2>
