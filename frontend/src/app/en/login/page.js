...
const FEATURES = [
    { icon: Search, text: 'SEO: title, meta, H1, alt text & all issues' },
    { icon: Globe, text: 'GEO: llms.txt, schema, AI crawlers & all checks' },
        ...
        <div className="min-h-screen bg-[var(--bg-base)] flex">
              ...
              Scanora
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-[var(--text-muted)] text-sm leading-relaxed mb-8">
                        Your reports and audits are waiting for you. All analyses in one place.
                    </p>
                ...
                <div className="relative z-10">
                    <div className="bg-[var(--surface-06)] border border-[var(--border-subtle)] rounded-2xl p-4">
                        <div className="text-[10px] text-[var(--text-faint)] uppercase tracking-wider mb-3">Last audit</div>
            ...
            <div className="flex-1 flex items-center justify-center px-5 py-12">
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="relative z-10 w-full max-w-md">
                    ...
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-[var(--text-white)] mb-2">Log in</h1>
                        <p className="text-[var(--text-muted)] text-sm">Access your reports and audits</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                <label className="text-sm text-[var(--text-body)] font-medium">Password</label>
                                <Link href="/en/forgot-password" className="text-xs text-[var(--text-faint)] hover:text-[var(--accent)] transition-colors">Forgot?</Link>
                            </div>
                            <div className="relative">
                        ...
                        <motion.button type="submit" disabled={loading} whileTap={{ scale: 0.98 }}
                            ...
                            {loading ? (
                                <><div className="w-4 h-4 border-2 border-[var(--bg-base)]/30 border-t-[var(--bg-base)] rounded-full animate-spin" />Logging in...</>
                            ) : (
                    ...
                    <div className="mt-6 text-center text-sm text-[var(--text-faint)]">
                        ...
                        <Link href="/en/register" className="text-[var(--text-white)] hover:text-[var(--accent)] font-medium transition-colors">
                            Sign up now
                        </Link>
                    </div>
