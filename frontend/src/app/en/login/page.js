              ...
              Audit<span className="text-transparent bg-clip-text bg-linear-to-r from-violet-400 to-cyan-400">AI</span>
                ...
                <div className="relative z-10">
                    <h2 className="text-4xl font-bold text-white leading-tight mb-4">
                        Welcome<br />
                        <span className="text-transparent bg-clip-text bg-linear-to-r from-violet-400 to-cyan-400">back.</span>
                    </h2>
            ...
            <div className="flex-1 flex items-center justify-center px-5 py-12">
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="relative z-10 w-full max-w-md">
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <Link href="/en/forgot-password" className="text-xs text-slate-500 hover:text-violet-400 transition-colors">Forgot?</Link>
                            </div>
                            <div className="relative">
                    ...
                    <div className="mt-6 text-center text-sm text-slate-500">
                        ...
                        <Link href="/en/register" className="text-violet-400 hover:text-violet-300 font-medium transition-colors">
                            Sign up now
                        </Link>
                    </div>
