                ...
                <div className="relative z-10">
                    <Link href="/en" className="flex items-center gap-2.5 group">
                        <div className="w-9 h-9 rounded-xl bg-[var(--accent)] flex items-center justify-center shadow-lg shadow-[var(--accent-border)]">
                            <Zap className="w-4.5 h-4.5 text-[var(--bg-base)]" strokeWidth={2.5} />
                        </div>
              ...
              AuditAI
                ...
                <div className="relative z-10">
                    <div className="bg-[var(--surface-06)] border border-[var(--border-subtle)] rounded-2xl p-4">
                        <div className="text-[10px] text-slate-600 uppercase tracking-wider mb-3">Last audit</div>
            ...
            <div className="flex-1 flex items-center justify-center px-5 py-12">
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="relative z-10 w-full max-w-md">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-slate-400 text-sm">Access your reports and audits</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <Link href="/en/forgot-password" className="text-xs text-slate-500 hover:text-[var(--accent)] transition-colors">Forgot?</Link>
                            </div>
                            <div className="relative">
                    ...
                    <div className="mt-6 text-center text-sm text-slate-500">
                        ...
                        <Link href="/en/register" className="text-white hover:text-[var(--accent)] font-medium transition-colors">
                            Sign up now
                        </Link>
                    </div>
