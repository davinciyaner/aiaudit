...
export default function TicketStatusPageEn() {
            ...
            <div className="flex-1 flex items-center justify-center px-5 py-16">
                ...
                {notFound && (
                    <div className="text-center">
                        ...
                        <p className="text-slate-400 text-sm mb-6">Ticket number <span className="font-mono text-slate-300">{ticketId}</span> doesn't exist.</p>
                ...
                {ticket && currentStatus && (
                    ...
                    >
                        ...
                        <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-6">
                            <p className="text-xs text-slate-500 uppercase tracking-wider font-semibold mb-5">History</p>
