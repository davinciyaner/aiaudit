        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
            ...
            {done ? (
                <div className="bg-[var(--surface-06)] border border-[var(--border-subtle)] rounded-2xl p-8 text-center">
                    ...
                    <p className="text-slate-400 text-sm">You'll be automatically redirected to login...</p>
                </div>
            ) : (
                <>
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-white mb-2">New password</h1>
                        <p className="text-slate-400 text-sm">Choose a secure password for your account.</p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            <label className="text-sm text-slate-300 mb-2 block font-medium">New password</label>
                        ...
                        <div>
                            <label className="text-sm text-slate-300 mb-2 block font-medium">Confirm password</label>
                            <div className="relative">
                                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500" />
                                <input
                                    type="password"
